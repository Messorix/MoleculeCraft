package com.messorix.moleculecraft.base.slots;
...
public class SlotFluxGrinderOutput extends Slot
{
    /** The player that is using the GUI where this slot resides. */
    private final EntityPlayer thePlayer;
    private int numGrinderOutput;

    public SlotFluxGrinderOutput(EntityPlayer parPlayer, 
    ...
    protected void onCrafting(ItemStack parItemStack)
    {
        if (!thePlayer.worldObj.isRemote)
        {
            ...
            float expFactor = FluxGrinderRecipes.instance()
                  .getProcessingExperience(parItemStack);
